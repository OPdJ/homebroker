...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.menu.nav' => 'getApp_Menu_NavService',
            'app.ordem_service' => 'getApp_OrdemServiceService',
    ...
    /**
     * Gets the public 'app.menu.nav' shared service.
     *
     * @return \AppBundle\Utils\html\navigation\MenuNavigation
     */
    protected function getApp_Menu_NavService()
    {
        return $this->services['app.menu.nav'] = new \AppBundle\Utils\html\navigation\MenuNavigation();
    }

    /**
     * Gets the public 'app.ordem_service' shared service.
     *
     * @return \AppBundle\Service\OrdemService
     */
    protected function getApp_OrdemServiceService()
    {
        return $this->services['app.ordem_service'] = new \AppBundle\Service\OrdemService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bolsavalores', 'user' => 'root', 'password' => 12345, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_74647d91caaee41340054746178d425212e679181da62b1cc531d6068b36904d');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('app_name', 'HomeBroker');
        $instance->addGlobal('welcome_title', 'Welcome!');
        $instance->addGlobal('app_menu_nav', $this->get('app.menu.nav'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('homebroker');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b02b7f0a17d35.20573846')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.ruby.bin' => 'C:\\tools\\ruby24\\bin\\ruby.EXE',
